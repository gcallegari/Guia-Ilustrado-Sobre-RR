...
import 'package:guia_app/widgets/info_atvd3.dart';
import 'package:scoped_model/scoped_model.dart';

class ListAtvd3 extends StatefulWidget {
  @override
  _ListAtvd3State createState() => _ListAtvd3State();
}

class _ListAtvd3State extends State<ListAtvd3> {
  Future getAtividade() async {
    QuerySnapshot query = await Firestore.instance
        .collection("users")
        .document()
        .collection("atividade3")
        .getDocuments();
